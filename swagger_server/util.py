...
def parse_cookie(cookie_str,cookie_key):
    logging.debug("cookie string %s",cookie_str)
    matches = re.findall(r'Autorization=(.*)', cookie_str)
    logging.debug("Parsed cookie list %s",matches)
    return matches
